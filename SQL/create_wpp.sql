...
CREATE TABLE IF NOT EXISTS `wpp`.`sniff_data` (
  ...
  `ObjectType` ENUM('None','Spell','Map','LFGDungeon','Battleground','Unit','GameObject','Item','Quest','QuestObjective','QuestGreeting','Opcode','PageText','NpcText','Gossip','Zone','Area','AreaTrigger','Phase','Player','Currency','Achievement') NOT NULL DEFAULT 'None', -- StoreNameType.cs enum
